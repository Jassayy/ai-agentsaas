import { validateAdditionalInfo, ValidationResult } from "./../lib/type";
import { validateBasicInfo, validateCTA, ValidationErrors } from "@/lib/type";
...
export const useWebinarStore = create<WebinarStore>((set, get) => ({
     ...
     updateAdditionalInfoField: (field, value) => {
          set((state) => {
               ...
               const validationResult =
                    validateAdditionalInfo(newAdditionalInfo);
     ...
     validateStep: (stepId: keyof WebinarFormState) => {
          ...
          switch (stepId) {
               ...
               case "additionalInfo":
                    validationResult = validateAdditionalInfo(
