...
const MultiStepForm = ({ steps, onComplete }: Props) => {
          ...
          if (isLastStep) {
               try {
                    ...
                    if (result.status === 200 && result.webinarId) {
                         ...
                         toast.error(
                              result.message ||
                                   "Your webinar was not created, try again please."
                         );
                    ...
                    setValidationError("Failed to create webinar");
               } finally {
                    setSubmitting(false);
               }
          }
     ...
     bg-[#27272A]/20 rounded-3xl overflow-hidden max-w-6xl mx-auto backdrop-blur-[106px]"
          >
                    ...
                    <div className="w-full md:w-2/3">
                         <AnimatePresence mode="wait">
                              ...
                              >
                                   ...
                                   {validationError && (
                                        <div className="mt-4 p-3 bg-red-900/3 border border-red-800 rounded-md flex items-start gap-2 text-red-300">
